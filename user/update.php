...
if (
	...
	if (isset($_POST['submit'])) {
	  ...
	  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        ...
        WHERE id=" . $_SESSION['user_id'];
			...
			<strong>Data updated Sucessfully.</strong>
			<button type="button" class="close" data-dismiss="alert" aria-label="Close">
			  <span aria-hidden="true">&times;</span>
			</button>
		  </div>';
	...
	if(isset($_POST['userID'])){
		...
		if(mysqli_query($connection,$sql)){
			...
			<strong>OOps!!! Account Not Deleted.</strong>
			<button type="button" class="close" data-dismiss="alert" aria-label="Close">
			  <span aria-hidden="true">&times;</span>
			</button>
		  </div>';
					...
					<form class="form-group" action="" method="post">
						...
						<div class="form-group">
							...
							<input type="text" name="contact_no" placeholder="91********" class="form-control" required
								pattern="^\d{11}$" title="11 numeric characters only" maxlength="11" value="<?php if (isset($contact))
									echo $contact; ?>">
						...
						<div class="form-group">
							...
							<select name="city" id="city" class="form-control demo-default" required>
								...
								<optgroup title="Azad Jammu and Kashmir (Azad Kashmir)x`"
